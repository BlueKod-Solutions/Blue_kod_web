...
export class AboutComponent {
  team: TeamMember[] = [
    { emoji: '👨‍💻', name: 'Manoj J.',  role: 'Lead Developer', bg: 'rgba(59,130,246,.12)' },
    { emoji: '👩‍🎨', name: 'Aarva.',  role: 'UI/UX Designer',  bg: 'rgba(6,182,212,.12)' },
    { emoji: '🤖',   name: 'Shashank.',    role: 'AI Engineer',      bg: 'rgba(129,140,248,.12)' },
    { emoji: '📊',   name: 'Sanath S Shetty.', role: 'Project Lead',     bg: 'rgba(34,197,94,.12)' },
  ];
